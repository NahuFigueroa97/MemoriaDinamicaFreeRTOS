...
t_key_config keys_config[] = { TEC1, TEC2};
TickType_t GameTime;
...
void keys_Init(void) {
	...
	QueueAux = xQueueCreate(nQueueAux, sizeof( uint32_t ));

	configASSERT ( QueueAux != NULL);
}
